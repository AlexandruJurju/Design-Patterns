...
public abstract class Pizza
{
    ...
    public override string ToString()
    {
        ...
        if (Dough != null) result.AppendLine(Dough.Name);

        if (Sauce != null) result.AppendLine(Sauce.Name);

        if (Cheese != null) result.AppendLine(Cheese.Name);
        ...
        if (Clam != null) result.AppendLine(Clam.Name);

        if (Pepperoni != null) result.AppendLine(Pepperoni.Name);
